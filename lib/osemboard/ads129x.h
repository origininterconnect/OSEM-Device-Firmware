 ...
 * Copyright (c) 2012-2016 Kendrick Shaw, Ace Medlock, and Eric Herman
...
namespace ADS129x
{
    ...
    enum CONFIG1_bits
    {
        ...
        // ADS1298
        ADS1298_HIGH_RES_32k_SPS = HR,
        ADS1298_HIGH_RES_16k_SPS = (HR | DR0),
        ADS1298_HIGH_RES_8k_SPS = (HR | DR1),
        ADS1298_HIGH_RES_4k_SPS = (HR | DR1 | DR0),
        ADS1298_HIGH_RES_2k_SPS = (HR | DR2),
        ADS1298_HIGH_RES_1k_SPS = (HR | DR2 | DR0),
        ADS1298_HIGH_RES_500_SPS = (HR | DR2 | DR1),
        ADS1298_LOW_POWR_250_SPS = (DR2 | DR1),
